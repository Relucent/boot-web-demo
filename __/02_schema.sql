...
CREATE TABLE `department`  (
  ...
  `ordinal` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '序位',
  `id_path` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '' COMMENT 'ID路径',
...
CREATE TABLE `user`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '名称',
  `remark` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备注',
  `enabled` int(11) NULL DEFAULT 1 COMMENT '是否启用(0禁用,1启用)',
  `version` bigint(20) NOT NULL DEFAULT 0 COMMENT '版本号',
  `deleted` int(11) NOT NULL DEFAULT 0 COMMENT '删除标记(0正常,1删除)',
  `created_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '创建者',
  `created_at` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `user_role`  (
  ...
  `deleted` int(11) NULL DEFAULT NULL COMMENT '删除标记(0正常,1删除)',
  `created_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '创建者',
  `created_at` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '最后修改者',
  `updated_at` datetime(0) NULL DEFAULT NULL COMMENT '最后修改时间',
