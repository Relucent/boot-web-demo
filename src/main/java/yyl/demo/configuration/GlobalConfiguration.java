...
import com.github.relucent.base.plugin.jackson.JacksonUtil;
...
public class GlobalConfiguration {
	...
	public ObjectMapper objectMapper() {
		...
		om.registerModules(new SimpleModule() //
				...
				.addDeserializer(Mapx.class, MapxDeserializer.INSTANCE)//
				.addDeserializer(Listx.class, ListxDeserializer.INSTANCE)//
		);
