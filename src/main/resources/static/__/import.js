~function() {
	...
	document.writeln('<link  href="' + $ctx + '/__/element-ui/2.13.2/theme-chalk/index.css" type="text/css" rel="stylesheet"/>');
	document.writeln('<link  href="' + $ctx + '/__/__/__.css" type="text/css" rel="stylesheet"/>');
	document.writeln('<script src="' + $ctx + '/__/vue/2.6.11/vue.min.js"></script>');
	document.writeln('<script src="' + $ctx + '/__/element-ui/2.13.2/index.js"></script>');
	document.writeln('<script src="' + $ctx + '/__/axios/0.19.2/axios.min.js"></script>');
